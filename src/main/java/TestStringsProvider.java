 ...
 * =============================================================================
 *
 * Description - An abstract class providing an array of strings from which test items are created for a DDTTestRunner to iterate over and process
 ...
 * =============|=========|====================================
 */
public abstract class TestStringsProvider extends DDTBase{
