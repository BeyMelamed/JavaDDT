...
public class TestEvent {
   ...
   private DDTestRunner.TestEventType eType;
   private Date timeStamp = new Date();
   private String id="";

   public static String eventName(DDTestRunner.TestEventType event) {
      String result = "";
      switch (event)
      {
   ...
   public TestEvent(DDTestRunner.TestEventType type, String message) {
      setType(type);
      setMessage(message);
      setTimeStamp();
   }
   ...
   public void setType(DDTestRunner.TestEventType value) {
      this.eType = value;
   }

   public DDTestRunner.TestEventType getType() {
      if (eType == null)
         setType(DDTestRunner.TestEventType.INIT);
      return eType;
   }
