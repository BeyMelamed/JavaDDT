...
public abstract class FileTestStringsProvider extends TestStringsProvider {
    ...
    * 10/31/15    |Bey      |Change the name of "Data" element to "Params" - improved readability
    * ============|=========|====================================
    */
   public static class JSONTestStringsProvider extends FileTestStringsProvider {
       ...
       *
       ...
       "TestItems": [
       {
          "id":"JSONTest#",
          "action": "NewTest",
          "params": "InputSpecs=File!DDTRoot.xlsx!Root",
               ...
               <table>
                  <tbody>
                     <tr>
                         ...
                         <td class="active"></td>
                         <td class="params">InputSpecs=File:DDTRoot.xls:Calculate</td>
                     ...
                     <tr>
                         ...
                         <td class="qryFunction"></td>
                         <td class="active"></td>
                         <td class="params">InputSpecs=File:DDTRoot.xls:ChainingFinders</td>
...
//      }
   ...
   public static class XMLTestStringsProvider extends FileTestStringsProvider {
      ...
      public class DDTestParser {
         ...
         static final String DATA = "Params";
