                ...
                <table align="center" width="100%" height="10%" border="0" cellspacing="1" bgcolor="#000000" id="alternate">
                  <tr>
                    <td width="50" bgcolor="#011414">
                      <img width="100" src="https://github.com/BeyMelamed/JavaDDT/blob/master/src/main/resources/Images/Client.png?raw=true" alt="https://github.com/BeyMelamed/JavaDDT/blob/master/src/main/resources/Images/Client.png?raw=true"></img>
                    </td>
